...
import { ApiApplicationGetDetailsResponseOwner } from './api-application-get-details-response-owner';
import { ApiApplicationGetDetailsResponsePreferences } from './api-application-get-details-response-preferences';

/**
 * 
 * @export
 * @interface ApiApplicationGetDetailsResponse
 */
export interface ApiApplicationGetDetailsResponse {
    /**
     * 
     * @type {string}
     * @memberof ApiApplicationGetDetailsResponse
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {ApiApplicationGetDetailsResponseOwner}
     * @memberof ApiApplicationGetDetailsResponse
     */
    'owner'?: ApiApplicationGetDetailsResponseOwner;
    /**
     * 
     * @type {ApiApplicationGetDetailsResponsePreferences}
     * @memberof ApiApplicationGetDetailsResponse
     */
    'preferences'?: ApiApplicationGetDetailsResponsePreferences;
}
