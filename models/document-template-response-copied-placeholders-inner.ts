 ...
 * 
 * @export
 * @interface DocumentTemplateResponseCopiedPlaceholdersInner
 */
export interface DocumentTemplateResponseCopiedPlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentTemplateResponseCopiedPlaceholdersInner
     */
