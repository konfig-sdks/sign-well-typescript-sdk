 ...
 * 
 * @export
 * @interface DocumentUpdateAndSendResponseCopiedContactsInner
 */
export interface DocumentUpdateAndSendResponseCopiedContactsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentUpdateAndSendResponseCopiedContactsInner
     */
    'email'?: string;
    /**
     * 
