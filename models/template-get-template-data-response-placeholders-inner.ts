...
import { TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInner } from './template-get-template-data-response-placeholders-inner-attachment-requests-inner';

/**
 * 
 * @export
 * @interface TemplateGetTemplateDataResponsePlaceholdersInner
 */
export interface TemplateGetTemplateDataResponsePlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateGetTemplateDataResponsePlaceholdersInner
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInner>}
     * @memberof TemplateGetTemplateDataResponsePlaceholdersInner
     */
    'attachment_requests'?: Array<TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInner>;
}
