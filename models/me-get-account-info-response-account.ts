...
import { MeGetAccountInfoResponseAccountActiveUsersInner } from './me-get-account-info-response-account-active-users-inner';

/**
 * 
 * @export
 * @interface MeGetAccountInfoResponseAccount
 */
export interface MeGetAccountInfoResponseAccount {
    /**
     * 
     * @type {string}
     * @memberof MeGetAccountInfoResponseAccount
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<MeGetAccountInfoResponseAccountActiveUsersInner>}
     * @memberof MeGetAccountInfoResponseAccount
     */
    'active_users'?: Array<MeGetAccountInfoResponseAccountActiveUsersInner>;
}
