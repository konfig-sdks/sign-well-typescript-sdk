...
import { TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInner } from './template-update-existing-template-response-placeholders-inner-attachment-requests-inner';

/**
 * 
 * @export
 * @interface TemplateUpdateExistingTemplateResponsePlaceholdersInner
 */
export interface TemplateUpdateExistingTemplateResponsePlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateUpdateExistingTemplateResponsePlaceholdersInner
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInner>}
     * @memberof TemplateUpdateExistingTemplateResponsePlaceholdersInner
     */
    'attachment_requests'?: Array<TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInner>;
}
