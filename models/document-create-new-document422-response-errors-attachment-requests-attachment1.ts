 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsAttachmentRequestsAttachment1
 */
export interface DocumentCreateNewDocument422ResponseErrorsAttachmentRequestsAttachment1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsAttachmentRequestsAttachment1
     */
    'name'?: Array<string>;
}
