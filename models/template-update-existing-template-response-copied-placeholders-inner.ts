 ...
 * 
 * @export
 * @interface TemplateUpdateExistingTemplateResponseCopiedPlaceholdersInner
 */
export interface TemplateUpdateExistingTemplateResponseCopiedPlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateUpdateExistingTemplateResponseCopiedPlaceholdersInner
     */
    'id'?: string;
    /**
     * 
