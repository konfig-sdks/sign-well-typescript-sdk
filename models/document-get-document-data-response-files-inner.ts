 ...
 * 
 * @export
 * @interface DocumentGetDocumentDataResponseFilesInner
 */
export interface DocumentGetDocumentDataResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetDocumentDataResponseFilesInner
     */
    'name'?: string;
    /**
     * 
