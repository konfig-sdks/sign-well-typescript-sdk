 ...
 * 
 * @export
 * @interface BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData
 */
export interface BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData {
    /**
     * 
     * @type {string}
     * @memberof BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData
     */
    'document_sender_email'?: string;
    /**
     * 
     * @type {string}
     * @memberof BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData
