 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsFilesFile1
 */
export interface DocumentCreateFromTemplate422ResponseErrorsFilesFile1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsFilesFile1
     */
