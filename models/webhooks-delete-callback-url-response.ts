...
import { WebhooksDeleteCallbackUrlResponseMeta } from './webhooks-delete-callback-url-response-meta';

/**
 * 
 * @export
 * @interface WebhooksDeleteCallbackUrlResponse
 */
export interface WebhooksDeleteCallbackUrlResponse {
    /**
     * 
     * @type {string}
     * @memberof WebhooksDeleteCallbackUrlResponse
     */
    'message'?: string;
    /**
     * 
     * @type {WebhooksDeleteCallbackUrlResponseMeta}
     * @memberof WebhooksDeleteCallbackUrlResponse
     */
    'meta'?: WebhooksDeleteCallbackUrlResponseMeta;
}
