 ...
 * 
 * @export
 * @interface TemplateDeleteDocumentTemplateResponseMeta
 */
export interface TemplateDeleteDocumentTemplateResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof TemplateDeleteDocumentTemplateResponseMeta
     */
    'error'?: string;
    /**
     * 
