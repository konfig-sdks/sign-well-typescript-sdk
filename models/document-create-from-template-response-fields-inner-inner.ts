 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplateResponseFieldsInnerInner
 */
export interface DocumentCreateFromTemplateResponseFieldsInnerInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateFromTemplateResponseFieldsInnerInner
     */
    'api_id'?: string;
    /**
     * 
