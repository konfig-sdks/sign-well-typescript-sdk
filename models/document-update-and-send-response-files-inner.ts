 ...
 * 
 * @export
 * @interface DocumentUpdateAndSendResponseFilesInner
 */
export interface DocumentUpdateAndSendResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentUpdateAndSendResponseFilesInner
     */
    'name'?: string;
    /**
     * 
