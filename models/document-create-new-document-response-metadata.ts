 ...
 * 
 * @export
 * @interface DocumentCreateNewDocumentResponseMetadata
 */
export interface DocumentCreateNewDocumentResponseMetadata {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateNewDocumentResponseMetadata
     */
    'key1'?: string;
    /**
     * 
