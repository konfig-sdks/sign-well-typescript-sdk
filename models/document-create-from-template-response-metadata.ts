 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplateResponseMetadata
 */
export interface DocumentCreateFromTemplateResponseMetadata {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateFromTemplateResponseMetadata
     */
    'key1'?: string;
    /**
     * 
