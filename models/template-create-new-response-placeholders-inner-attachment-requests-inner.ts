 ...
 * 
 * @export
 * @interface TemplateCreateNewResponsePlaceholdersInnerAttachmentRequestsInner
 */
export interface TemplateCreateNewResponsePlaceholdersInnerAttachmentRequestsInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateCreateNewResponsePlaceholdersInnerAttachmentRequestsInner
     */
    'name'?: string;
    /**
     * 
