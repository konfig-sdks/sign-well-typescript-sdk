...
import { DocumentGetCompletedPdf404ResponseMeta } from './document-get-completed-pdf404-response-meta';

/**
 * 
 * @export
 * @interface DocumentGetCompletedPdf404Response
 */
export interface DocumentGetCompletedPdf404Response {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetCompletedPdf404Response
     */
    'message'?: string;
    /**
     * 
     * @type {DocumentGetCompletedPdf404ResponseMeta}
     * @memberof DocumentGetCompletedPdf404Response
     */
    'meta'?: DocumentGetCompletedPdf404ResponseMeta;
}
