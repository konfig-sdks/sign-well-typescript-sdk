 ...
 * 
 * @export
 * @interface TemplateUpdateExistingTemplate400ResponseErrors
 */
export interface TemplateUpdateExistingTemplate400ResponseErrors {
    /**
     * 
     * @type {string}
     * @memberof TemplateUpdateExistingTemplate400ResponseErrors
     */
    'message'?: string;
    /**
     * 
