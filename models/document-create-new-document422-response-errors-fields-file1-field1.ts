 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFieldsFile1Field1
 */
export interface DocumentCreateNewDocument422ResponseErrorsFieldsFile1Field1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFieldsFile1Field1
     */
