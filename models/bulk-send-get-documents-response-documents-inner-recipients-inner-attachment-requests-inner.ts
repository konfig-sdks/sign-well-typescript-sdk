...
import { BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInnerOneOf } from './bulk-send-get-documents-response-documents-inner-recipients-inner-attachment-requests-inner-one-of';

/**
 * @type BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInner
 * @export
 */
export type BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInner = BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInnerOneOf | string;
