...
import { DocumentCreateFromTemplate422ResponseErrorsFieldsFile1Field1 } from './document-create-from-template422-response-errors-fields-file1-field1';

/**
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsFieldsFile1
 */
export interface DocumentCreateFromTemplate422ResponseErrorsFieldsFile1 {
    /**
     * 
     * @type {DocumentCreateFromTemplate422ResponseErrorsFieldsFile1Field1}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsFieldsFile1
     */
    'field_1'?: DocumentCreateFromTemplate422ResponseErrorsFieldsFile1Field1;
}
