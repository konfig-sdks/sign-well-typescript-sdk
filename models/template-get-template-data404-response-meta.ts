 ...
 * 
 * @export
 * @interface TemplateGetTemplateData404ResponseMeta
 */
export interface TemplateGetTemplateData404ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof TemplateGetTemplateData404ResponseMeta
     */
    'error'?: string;
    /**
     * 
