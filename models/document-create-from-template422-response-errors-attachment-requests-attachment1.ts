 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsAttachmentRequestsAttachment1
 */
export interface DocumentCreateFromTemplate422ResponseErrorsAttachmentRequestsAttachment1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsAttachmentRequestsAttachment1
     */
    'name'?: Array<string>;
}
