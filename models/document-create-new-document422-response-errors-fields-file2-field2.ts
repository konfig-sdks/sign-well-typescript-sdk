 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFieldsFile2Field2
 */
export interface DocumentCreateNewDocument422ResponseErrorsFieldsFile2Field2 {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFieldsFile2Field2
     */
