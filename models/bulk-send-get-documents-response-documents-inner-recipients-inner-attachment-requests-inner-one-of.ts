 ...
 * 
 * @export
 * @interface BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInnerOneOf
 */
export interface BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInnerOneOf {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetDocumentsResponseDocumentsInnerRecipientsInnerAttachmentRequestsInnerOneOf
     */
    'name'?: string;
    /**
     * 
