 ...
 * 
 * @export
 * @interface BulkSendCreateValidationCsv401ResponseMeta
 */
export interface BulkSendCreateValidationCsv401ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof BulkSendCreateValidationCsv401ResponseMeta
     */
    'error'?: string;
    /**
     * 
