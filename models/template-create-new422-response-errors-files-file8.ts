 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile8
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile8 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile8
     */
