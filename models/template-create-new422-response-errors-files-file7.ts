 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile7
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile7 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile7
     */
