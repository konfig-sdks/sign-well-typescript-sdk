...
import { DocumentCreateFromTemplate422ResponseErrorsAttachmentRequestsAttachment1 } from './document-create-from-template422-response-errors-attachment-requests-attachment1';

/**
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsAttachmentRequests
 */
export interface DocumentCreateFromTemplate422ResponseErrorsAttachmentRequests {
    /**
     * 
     * @type {DocumentCreateFromTemplate422ResponseErrorsAttachmentRequestsAttachment1}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsAttachmentRequests
     */
    'attachment_1'?: DocumentCreateFromTemplate422ResponseErrorsAttachmentRequestsAttachment1;
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsAttachmentRequests
