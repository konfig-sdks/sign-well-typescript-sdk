...
import { BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData } from './bulk-send-create-validation-csv422-response-errors-bulk-send-csv-inner-data';

/**
 * 
 * @export
 * @interface BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner
 */
export interface BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner {
    /**
     * 
     * @type {number}
     * @memberof BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner
     */
    'row'?: number;
    /**
     * 
     * @type {BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData}
     * @memberof BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner
     */
    'data'?: BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInnerData;
    /**
     * 
     * @type {Array<string>}
     * @memberof BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner
