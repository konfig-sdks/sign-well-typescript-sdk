...
import { DocumentCreateNewDocument422ResponseErrorsFieldsFile1Field1 } from './document-create-new-document422-response-errors-fields-file1-field1';

/**
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFieldsFile1
 */
export interface DocumentCreateNewDocument422ResponseErrorsFieldsFile1 {
    /**
     * 
     * @type {DocumentCreateNewDocument422ResponseErrorsFieldsFile1Field1}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFieldsFile1
     */
    'field_1'?: DocumentCreateNewDocument422ResponseErrorsFieldsFile1Field1;
}
