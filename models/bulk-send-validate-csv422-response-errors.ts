...
import { BulkSendValidateCsv422ResponseErrorsBulkSendCsvInner } from './bulk-send-validate-csv422-response-errors-bulk-send-csv-inner';

/**
 * 
 * @export
 * @interface BulkSendValidateCsv422ResponseErrors
 */
export interface BulkSendValidateCsv422ResponseErrors {
    /**
     * 
     * @type {Array<BulkSendValidateCsv422ResponseErrorsBulkSendCsvInner>}
     * @memberof BulkSendValidateCsv422ResponseErrors
     */
    'bulk_send_csv'?: Array<BulkSendValidateCsv422ResponseErrorsBulkSendCsvInner>;
}
