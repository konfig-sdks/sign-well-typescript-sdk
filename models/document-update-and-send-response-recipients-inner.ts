 ...
 * 
 * @export
 * @interface DocumentUpdateAndSendResponseRecipientsInner
 */
export interface DocumentUpdateAndSendResponseRecipientsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentUpdateAndSendResponseRecipientsInner
     */
    'id'?: string;
    /**
     * 
