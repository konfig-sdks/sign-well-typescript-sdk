 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFieldsFile2Field3
 */
export interface DocumentCreateNewDocument422ResponseErrorsFieldsFile2Field3 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFieldsFile2Field3
     */
