 ...
 * 
 * @export
 * @interface DocumentResponseFieldsInnerInnerRecipient
 */
export interface DocumentResponseFieldsInnerInnerRecipient {
    /**
     * 
     * @type {string}
     * @memberof DocumentResponseFieldsInnerInnerRecipient
     */
    'email': string;
    /**
     * 
