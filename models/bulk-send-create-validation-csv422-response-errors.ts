...
import { BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner } from './bulk-send-create-validation-csv422-response-errors-bulk-send-csv-inner';

/**
 * 
 * @export
 * @interface BulkSendCreateValidationCsv422ResponseErrors
 */
export interface BulkSendCreateValidationCsv422ResponseErrors {
    /**
     * 
     * @type {Array<BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner>}
     * @memberof BulkSendCreateValidationCsv422ResponseErrors
     */
    'bulk_send_csv'?: Array<BulkSendCreateValidationCsv422ResponseErrorsBulkSendCsvInner>;
}
