 ...
 * 
 * @export
 * @interface DocumentGetDocumentData404ResponseMeta
 */
export interface DocumentGetDocumentData404ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetDocumentData404ResponseMeta
     */
    'error'?: string;
    /**
     * 
