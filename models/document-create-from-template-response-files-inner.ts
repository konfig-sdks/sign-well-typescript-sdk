 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplateResponseFilesInner
 */
export interface DocumentCreateFromTemplateResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateFromTemplateResponseFilesInner
     */
    'name'?: string;
    /**
     * 
