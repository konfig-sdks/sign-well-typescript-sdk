 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFilesFile2
 */
export interface DocumentCreateNewDocument422ResponseErrorsFilesFile2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFilesFile2
     */
