 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile5
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile5 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile5
     */
    'name'?: Array<string>;
}
