 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFilesFile4
 */
export interface DocumentCreateNewDocument422ResponseErrorsFilesFile4 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFilesFile4
     */
