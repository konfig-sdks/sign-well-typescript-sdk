 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsFilesFile6
 */
export interface DocumentCreateFromTemplate422ResponseErrorsFilesFile6 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsFilesFile6
     */
    'name'?: Array<string>;
}
