 ...
 * 
 * @export
 * @interface TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInnerOneOf
 */
export interface TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInnerOneOf {
    /**
     * 
     * @type {string}
     * @memberof TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInnerOneOf
     */
    'name'?: string;
    /**
     * 
