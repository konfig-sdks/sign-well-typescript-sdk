 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile4
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile4 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile4
     */
