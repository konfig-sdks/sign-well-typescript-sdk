 ...
 * 
 * @export
 * @interface BulkSendListBulkSendings401ResponseMeta
 */
export interface BulkSendListBulkSendings401ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof BulkSendListBulkSendings401ResponseMeta
     */
    'error'?: string;
    /**
     * 
