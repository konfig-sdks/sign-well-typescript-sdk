...
import { TemplateGetTemplateData404ResponseMeta } from './template-get-template-data404-response-meta';

/**
 * 
 * @export
 * @interface TemplateGetTemplateData404Response
 */
export interface TemplateGetTemplateData404Response {
    /**
     * 
     * @type {string}
     * @memberof TemplateGetTemplateData404Response
     */
    'message'?: string;
    /**
     * 
     * @type {TemplateGetTemplateData404ResponseMeta}
     * @memberof TemplateGetTemplateData404Response
     */
    'meta'?: TemplateGetTemplateData404ResponseMeta;
}
