...
import { DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInnerOneOf } from './document-get-document-data-response-recipients-inner-attachment-requests-inner-one-of';

/**
 * @type DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInner
 * @export
 */
export type DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInner = DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInnerOneOf | string;
