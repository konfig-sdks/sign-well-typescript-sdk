 ...
 * 
 * @export
 * @interface DocumentSendReminderResponseFilesInner
 */
export interface DocumentSendReminderResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentSendReminderResponseFilesInner
     */
    'name'?: string;
    /**
     * 
