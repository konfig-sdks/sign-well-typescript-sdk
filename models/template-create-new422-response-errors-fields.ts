...
import { TemplateCreateNew422ResponseErrorsFieldsFile2 } from './template-create-new422-response-errors-fields-file2';

/**
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFields
 */
export interface TemplateCreateNew422ResponseErrorsFields {
    /**
     * 
     * @type {string}
     * @memberof TemplateCreateNew422ResponseErrorsFields
     */
    ...
    /**
     * 
     * @type {TemplateCreateNew422ResponseErrorsFieldsFile2}
     * @memberof TemplateCreateNew422ResponseErrorsFields
     */
    'file_2'?: TemplateCreateNew422ResponseErrorsFieldsFile2;
}
