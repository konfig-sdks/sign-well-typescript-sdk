 ...
 * 
 * @export
 * @interface DocumentResponseRecipientsInnerAttachmentRequestsInner
 */
export interface DocumentResponseRecipientsInnerAttachmentRequestsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentResponseRecipientsInnerAttachmentRequestsInner
     */
    'name': string;
    /**
     * 
