 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFilesFile6
 */
export interface DocumentCreateNewDocument422ResponseErrorsFilesFile6 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFilesFile6
     */
    'name'?: Array<string>;
}
