...
import { TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1 } from './template-create-new422-response-errors-placeholders-placeholder1';
import { TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder2 } from './template-create-new422-response-errors-placeholders-placeholder2';

/**
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsPlaceholders
 */
export interface TemplateCreateNew422ResponseErrorsPlaceholders {
    /**
     * 
     * @type {string}
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholders
     */
    'duplicated_ids'?: string;
    /**
     * 
     * @type {TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1}
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholders
     */
    'placeholder_1'?: TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1;
    /**
     * 
     * @type {TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder2}
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholders
     */
