...
import { TemplateCreateNewResponsePlaceholdersInnerAttachmentRequestsInner } from './template-create-new-response-placeholders-inner-attachment-requests-inner';

/**
 * 
 * @export
 * @interface TemplateCreateNewResponsePlaceholdersInner
 */
export interface TemplateCreateNewResponsePlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateCreateNewResponsePlaceholdersInner
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TemplateCreateNewResponsePlaceholdersInnerAttachmentRequestsInner>}
     * @memberof TemplateCreateNewResponsePlaceholdersInner
     */
    'attachment_requests'?: Array<TemplateCreateNewResponsePlaceholdersInnerAttachmentRequestsInner>;
}
