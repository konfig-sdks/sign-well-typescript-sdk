...
import { ApiApplicationDeleteByIdResponseMeta } from './api-application-delete-by-id-response-meta';

/**
 * 
 * @export
 * @interface ApiApplicationDeleteByIdResponse
 */
export interface ApiApplicationDeleteByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof ApiApplicationDeleteByIdResponse
     */
    'message'?: string;
    /**
     * 
     * @type {ApiApplicationDeleteByIdResponseMeta}
     * @memberof ApiApplicationDeleteByIdResponse
     */
    'meta'?: ApiApplicationDeleteByIdResponseMeta;
}
