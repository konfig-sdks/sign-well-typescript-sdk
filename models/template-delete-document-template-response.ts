...
import { TemplateDeleteDocumentTemplateResponseMeta } from './template-delete-document-template-response-meta';

/**
 * 
 * @export
 * @interface TemplateDeleteDocumentTemplateResponse
 */
export interface TemplateDeleteDocumentTemplateResponse {
    /**
     * 
     * @type {string}
     * @memberof TemplateDeleteDocumentTemplateResponse
     */
    'message'?: string;
    /**
     * 
     * @type {TemplateDeleteDocumentTemplateResponseMeta}
     * @memberof TemplateDeleteDocumentTemplateResponse
     */
    'meta'?: TemplateDeleteDocumentTemplateResponseMeta;
}
