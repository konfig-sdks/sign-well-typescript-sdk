 ...
 * 
 * @export
 * @interface DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInnerOneOf
 */
export interface DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInnerOneOf {
    /**
     * 
     * @type {string}
     * @memberof DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInnerOneOf
     */
    'name'?: string;
    /**
     * 
