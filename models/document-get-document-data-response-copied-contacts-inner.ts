 ...
 * 
 * @export
 * @interface DocumentGetDocumentDataResponseCopiedContactsInner
 */
export interface DocumentGetDocumentDataResponseCopiedContactsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetDocumentDataResponseCopiedContactsInner
     */
    'name'?: string;
    /**
     * 
