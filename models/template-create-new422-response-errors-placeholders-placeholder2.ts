 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder2
 */
export interface TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder2
     */
