 ...
 * 
 * @export
 * @interface DocumentCreateNewDocumentResponseFilesInner
 */
export interface DocumentCreateNewDocumentResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateNewDocumentResponseFilesInner
     */
    'name'?: string;
    /**
     * 
