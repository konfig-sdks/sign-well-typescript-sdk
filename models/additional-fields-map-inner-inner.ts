 ...
 * 
 * @export
 * @interface AdditionalFieldsMapInnerInner
 */
export interface AdditionalFieldsMapInnerInner {
    /**
     * Horizontal value in the coordinates of the field (in pixels). Coordinates are specific to the page where fields are located.
     * @type {number}
     * @memberof AdditionalFieldsMapInnerInner
     */
    'x': number;
    /**
     ...
     * @memberof AdditionalFieldsMapInnerInner
     */
    'type': AdditionalFieldsMapInnerInnerTypeEnum;
    /**
     ...
     * @memberof AdditionalFieldsMapInnerInner
     */
    'validation'?: AdditionalFieldsMapInnerInnerValidationEnum;
    /**
     ...
     * @memberof AdditionalFieldsMapInnerInner
     */
    'date_format'?: AdditionalFieldsMapInnerInnerDateFormatEnum;
}

type AdditionalFieldsMapInnerInnerTypeEnum = 'initials' | 'signature' | 'checkbox' | 'date' | 'text' | 'autofill_company' | 'autofill_email' | 'autofill_first_name' | 'autofill_last_name' | 'autofill_name' | 'autofill_phone' | 'autofill_title' | 'autofill_date_signed'
type AdditionalFieldsMapInnerInnerValidationEnum = 'no_text_validation' | 'numbers' | 'letters' | 'email_address' | 'us_phone_number' | 'us_zip_code' | 'us_ssn' | 'us_age' | 'alphanumeric' | 'us_bank_routing_number' | 'us_bank_account_number'
type AdditionalFieldsMapInnerInnerDateFormatEnum = 'MM/DD/YYYY' | 'DD/MM/YYYY' | 'YYYY/MM/DD' | 'Month DD, YYYY' | 'MM/DD/YYYY hh:mm:ss a'
