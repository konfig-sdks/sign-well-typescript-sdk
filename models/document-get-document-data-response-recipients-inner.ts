...
import { DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInner } from './document-get-document-data-response-recipients-inner-attachment-requests-inner';

/**
 * 
 * @export
 * @interface DocumentGetDocumentDataResponseRecipientsInner
 */
export interface DocumentGetDocumentDataResponseRecipientsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetDocumentDataResponseRecipientsInner
     */
    'email'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInner>}
     * @memberof DocumentGetDocumentDataResponseRecipientsInner
     */
    'attachment_requests'?: Array<DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInner>;
}
