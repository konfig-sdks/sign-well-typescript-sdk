 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile2
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile2
     */
