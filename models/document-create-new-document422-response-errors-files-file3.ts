 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFilesFile3
 */
export interface DocumentCreateNewDocument422ResponseErrorsFilesFile3 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFilesFile3
     */
