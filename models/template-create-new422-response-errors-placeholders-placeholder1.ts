 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1
 */
export interface TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1
     */
    'name'?: Array<string>;
    /**
     * 
     ...
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1
     */
    'preassigned_recipient_email'?: Array<string>;
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsPlaceholdersPlaceholder1
     */
    'preassigned_recipient_name'?: Array<string>;
}
