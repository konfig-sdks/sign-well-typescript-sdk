 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFieldsFile2Field2
 */
export interface TemplateCreateNew422ResponseErrorsFieldsFile2Field2 {
    /**
     * 
     * @type {string}
     * @memberof TemplateCreateNew422ResponseErrorsFieldsFile2Field2
     */
