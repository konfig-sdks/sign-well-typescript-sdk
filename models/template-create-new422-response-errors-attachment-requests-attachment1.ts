 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsAttachmentRequestsAttachment1
 */
export interface TemplateCreateNew422ResponseErrorsAttachmentRequestsAttachment1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsAttachmentRequestsAttachment1
     */
    'name'?: Array<string>;
}
