 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument400ResponseErrors
 */
export interface DocumentCreateNewDocument400ResponseErrors {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateNewDocument400ResponseErrors
     */
    'message'?: string;
    /**
     * 
