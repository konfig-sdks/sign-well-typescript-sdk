 ...
 * 
 * @export
 * @interface TemplateCreateNewResponseCopiedPlaceholdersInner
 */
export interface TemplateCreateNewResponseCopiedPlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateCreateNewResponseCopiedPlaceholdersInner
     */
    'id'?: string;
    /**
     * 
