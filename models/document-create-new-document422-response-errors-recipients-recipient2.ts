 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsRecipientsRecipient2
 */
export interface DocumentCreateNewDocument422ResponseErrorsRecipientsRecipient2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsRecipientsRecipient2
     */
    'email'?: Array<string>;
}
