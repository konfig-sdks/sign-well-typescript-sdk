 ...
 * 
 * @export
 * @interface TemplateGetTemplateDataResponseFilesInner
 */
export interface TemplateGetTemplateDataResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateGetTemplateDataResponseFilesInner
     */
    'name'?: string;
    /**
     * 
