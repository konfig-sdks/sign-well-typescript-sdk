 ...
 * 
 * @export
 * @interface ApiApplicationGetDetailsResponsePreferences
 */
export interface ApiApplicationGetDetailsResponsePreferences {
    /**
     * 
     * @type {string}
     * @memberof ApiApplicationGetDetailsResponsePreferences
     */
