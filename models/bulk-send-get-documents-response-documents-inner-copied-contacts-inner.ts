 ...
 * 
 * @export
 * @interface BulkSendGetDocumentsResponseDocumentsInnerCopiedContactsInner
 */
export interface BulkSendGetDocumentsResponseDocumentsInnerCopiedContactsInner {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetDocumentsResponseDocumentsInnerCopiedContactsInner
     */
    'name'?: string;
    /**
     * 
