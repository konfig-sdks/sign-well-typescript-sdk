 ...
 * 
 * @export
 * @interface DocumentUpdateAndSend422ResponseErrors
 */
export interface DocumentUpdateAndSend422ResponseErrors {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentUpdateAndSend422ResponseErrors
     */
