 ...
 * 
 * @export
 * @interface DocumentSendReminderResponseCopiedContactsInner
 */
export interface DocumentSendReminderResponseCopiedContactsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentSendReminderResponseCopiedContactsInner
     */
    'name'?: string;
    /**
     * 
