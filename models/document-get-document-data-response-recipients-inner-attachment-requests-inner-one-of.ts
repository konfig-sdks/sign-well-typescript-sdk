 ...
 * 
 * @export
 * @interface DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInnerOneOf
 */
export interface DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInnerOneOf {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetDocumentDataResponseRecipientsInnerAttachmentRequestsInnerOneOf
     */
    'name'?: string;
    /**
     * 
