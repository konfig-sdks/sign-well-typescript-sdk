 ...
 * 
 * @export
 * @interface DocumentFromTemplateResponseFieldsInnerInnerRecipient
 */
export interface DocumentFromTemplateResponseFieldsInnerInnerRecipient {
    /**
     * 
     * @type {string}
     * @memberof DocumentFromTemplateResponseFieldsInnerInnerRecipient
     */
    'email': string;
    /**
     * 
