 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile6
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile6 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile6
     */
    'name'?: Array<string>;
}
