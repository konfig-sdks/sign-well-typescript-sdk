 ...
 * 
 * @export
 * @interface DocumentResponseAttachmentRequestsInner
 */
export interface DocumentResponseAttachmentRequestsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentResponseAttachmentRequestsInner
     */
    'name': string;
    /**
     * 
