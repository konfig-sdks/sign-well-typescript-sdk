 ...
 * 
 * @export
 * @interface BulkSendGetDocumentsResponseDocumentsInnerMetadata
 */
export interface BulkSendGetDocumentsResponseDocumentsInnerMetadata {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetDocumentsResponseDocumentsInnerMetadata
     */
    'et'?: string;
    /**
     * 
