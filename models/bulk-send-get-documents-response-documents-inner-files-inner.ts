 ...
 * 
 * @export
 * @interface BulkSendGetDocumentsResponseDocumentsInnerFilesInner
 */
export interface BulkSendGetDocumentsResponseDocumentsInnerFilesInner {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetDocumentsResponseDocumentsInnerFilesInner
     */
    'name'?: string;
    /**
     * 
