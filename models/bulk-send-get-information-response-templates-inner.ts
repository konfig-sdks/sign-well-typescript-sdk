 ...
 * 
 * @export
 * @interface BulkSendGetInformationResponseTemplatesInner
 */
export interface BulkSendGetInformationResponseTemplatesInner {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetInformationResponseTemplatesInner
     */
    'id'?: string;
    /**
     * 
