...
import { DocumentDeleteDocumentResponseMeta } from './document-delete-document-response-meta';

/**
 * 
 * @export
 * @interface DocumentDeleteDocumentResponse
 */
export interface DocumentDeleteDocumentResponse {
    /**
     * 
     * @type {string}
     * @memberof DocumentDeleteDocumentResponse
     */
    'message'?: string;
    /**
     * 
     * @type {DocumentDeleteDocumentResponseMeta}
     * @memberof DocumentDeleteDocumentResponse
     */
    'meta'?: DocumentDeleteDocumentResponseMeta;
}
