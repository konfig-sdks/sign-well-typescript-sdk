 ...
 * 
 * @export
 * @interface DocumentCreateNewDocumentResponseCopiedContactsInner
 */
export interface DocumentCreateNewDocumentResponseCopiedContactsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateNewDocumentResponseCopiedContactsInner
     */
    'email'?: string;
    /**
     * 
