...
import { DocumentCreateNewDocument422ResponseErrorsAttachmentRequestsAttachment1 } from './document-create-new-document422-response-errors-attachment-requests-attachment1';

/**
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsAttachmentRequests
 */
export interface DocumentCreateNewDocument422ResponseErrorsAttachmentRequests {
    /**
     * 
     * @type {DocumentCreateNewDocument422ResponseErrorsAttachmentRequestsAttachment1}
     * @memberof DocumentCreateNewDocument422ResponseErrorsAttachmentRequests
     */
    'attachment_1'?: DocumentCreateNewDocument422ResponseErrorsAttachmentRequestsAttachment1;
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateNewDocument422ResponseErrorsAttachmentRequests
