 ...
 * 
 * @export
 * @interface BulkSendGetDocumentsResponseDocumentsInnerFieldsInnerInner
 */
export interface BulkSendGetDocumentsResponseDocumentsInnerFieldsInnerInner {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetDocumentsResponseDocumentsInnerFieldsInnerInner
     */
    'api_id'?: string;
    /**
     * 
