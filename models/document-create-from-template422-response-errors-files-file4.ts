 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsFilesFile4
 */
export interface DocumentCreateFromTemplate422ResponseErrorsFilesFile4 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsFilesFile4
     */
    'file_base64'?: Array<string>;
}
