 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsCopiedContactsCopiedContact1
 */
export interface DocumentCreateNewDocument422ResponseErrorsCopiedContactsCopiedContact1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsCopiedContactsCopiedContact1
     */
    'name'?: Array<string>;
    /**
     * 
