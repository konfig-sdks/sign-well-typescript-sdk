 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsRecipientsRecipient1
 */
export interface DocumentCreateFromTemplate422ResponseErrorsRecipientsRecipient1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsRecipientsRecipient1
     */
    'name'?: Array<string>;
    /**
     * 
