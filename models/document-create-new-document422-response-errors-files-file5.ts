 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsFilesFile5
 */
export interface DocumentCreateNewDocument422ResponseErrorsFilesFile5 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsFilesFile5
     */
    'name'?: Array<string>;
}
