 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplateResponseCopiedContactsInner
 */
export interface DocumentCreateFromTemplateResponseCopiedContactsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateFromTemplateResponseCopiedContactsInner
     */
    'email'?: string;
    /**
     * 
