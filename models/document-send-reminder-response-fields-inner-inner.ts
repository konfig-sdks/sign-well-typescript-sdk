 ...
 * 
 * @export
 * @interface DocumentSendReminderResponseFieldsInnerInner
 */
export interface DocumentSendReminderResponseFieldsInnerInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentSendReminderResponseFieldsInnerInner
     */
    'api_id'?: string;
    /**
     * 
