 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsCopiedContactsCopiedContact1
 */
export interface DocumentCreateFromTemplate422ResponseErrorsCopiedContactsCopiedContact1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsCopiedContactsCopiedContact1
     */
    'name'?: Array<string>;
    /**
     * 
