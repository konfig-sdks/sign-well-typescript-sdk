...
import { TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInnerOneOf } from './template-get-template-data-response-placeholders-inner-attachment-requests-inner-one-of';

/**
 * @type TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInner
 * @export
 */
export type TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInner = TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInnerOneOf | string;
