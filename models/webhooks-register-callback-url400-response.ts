...
import { WebhooksRegisterCallbackUrl400ResponseMeta } from './webhooks-register-callback-url400-response-meta';

/**
 * 
 * @export
 * @interface WebhooksRegisterCallbackUrl400Response
 */
export interface WebhooksRegisterCallbackUrl400Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksRegisterCallbackUrl400Response
     */
    'message'?: string;
    /**
     * 
     * @type {WebhooksRegisterCallbackUrl400ResponseMeta}
     * @memberof WebhooksRegisterCallbackUrl400Response
     */
    'meta'?: WebhooksRegisterCallbackUrl400ResponseMeta;
}
