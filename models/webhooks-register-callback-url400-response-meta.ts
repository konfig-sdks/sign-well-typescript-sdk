 ...
 * 
 * @export
 * @interface WebhooksRegisterCallbackUrl400ResponseMeta
 */
export interface WebhooksRegisterCallbackUrl400ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof WebhooksRegisterCallbackUrl400ResponseMeta
     */
    'error'?: string;
    /**
     * 
