 ...
 * 
 * @export
 * @interface ApiApplicationGetDetails404ResponseMeta
 */
export interface ApiApplicationGetDetails404ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof ApiApplicationGetDetails404ResponseMeta
     */
    'error'?: string;
    /**
     * 
