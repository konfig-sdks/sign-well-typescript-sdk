...
import { TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInnerOneOf } from './template-update-existing-template-response-placeholders-inner-attachment-requests-inner-one-of';

/**
 * @type TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInner
 * @export
 */
export type TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInner = TemplateUpdateExistingTemplateResponsePlaceholdersInnerAttachmentRequestsInnerOneOf | string;
