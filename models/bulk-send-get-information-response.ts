...
import { BulkSendGetInformationResponseTemplatesInner } from './bulk-send-get-information-response-templates-inner';

/**
 * 
 * @export
 * @interface BulkSendGetInformationResponse
 */
export interface BulkSendGetInformationResponse {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetInformationResponse
     */
    'id'?: string;
    /**
     * 
     ...
     * @memberof BulkSendGetInformationResponse
     */
    'documents_not_completed'?: number;
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetInformationResponse
    ...
    /**
     * 
     * @type {Array<BulkSendGetInformationResponseTemplatesInner>}
     * @memberof BulkSendGetInformationResponse
     */
    'templates'?: Array<BulkSendGetInformationResponseTemplatesInner>;
}
