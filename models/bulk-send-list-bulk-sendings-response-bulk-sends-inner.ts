 ...
 * 
 * @export
 * @interface BulkSendListBulkSendingsResponseBulkSendsInner
 */
export interface BulkSendListBulkSendingsResponseBulkSendsInner {
    /**
     * 
     * @type {string}
     * @memberof BulkSendListBulkSendingsResponseBulkSendsInner
     */
    'id'?: string;
    /**
     * 
