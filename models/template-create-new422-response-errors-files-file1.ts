 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile1
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile1
     */
