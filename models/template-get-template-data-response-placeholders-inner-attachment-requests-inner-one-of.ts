 ...
 * 
 * @export
 * @interface TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInnerOneOf
 */
export interface TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInnerOneOf {
    /**
     * 
     * @type {string}
     * @memberof TemplateGetTemplateDataResponsePlaceholdersInnerAttachmentRequestsInnerOneOf
     */
    'name'?: string;
    /**
     * 
