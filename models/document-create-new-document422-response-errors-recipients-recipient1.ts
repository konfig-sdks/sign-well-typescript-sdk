 ...
 * 
 * @export
 * @interface DocumentCreateNewDocument422ResponseErrorsRecipientsRecipient1
 */
export interface DocumentCreateNewDocument422ResponseErrorsRecipientsRecipient1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateNewDocument422ResponseErrorsRecipientsRecipient1
     */
    'name'?: Array<string>;
    /**
     * 
