 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsRecipientsRecipient2
 */
export interface DocumentCreateFromTemplate422ResponseErrorsRecipientsRecipient2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsRecipientsRecipient2
     */
    'email'?: Array<string>;
}
