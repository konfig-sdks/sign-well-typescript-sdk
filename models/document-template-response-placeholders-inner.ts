 ...
 * 
 * @export
 * @interface DocumentTemplateResponsePlaceholdersInner
 */
export interface DocumentTemplateResponsePlaceholdersInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentTemplateResponsePlaceholdersInner
     */
    'name': string;
    /**
     * 
