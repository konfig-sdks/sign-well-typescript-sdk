 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsFilesFile2
 */
export interface DocumentCreateFromTemplate422ResponseErrorsFilesFile2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsFilesFile2
     */
