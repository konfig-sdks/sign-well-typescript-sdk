 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsFilesFile5
 */
export interface DocumentCreateFromTemplate422ResponseErrorsFilesFile5 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsFilesFile5
     */
    'name'?: Array<string>;
}
