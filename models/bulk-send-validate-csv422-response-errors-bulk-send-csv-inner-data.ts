 ...
 * 
 * @export
 * @interface BulkSendValidateCsv422ResponseErrorsBulkSendCsvInnerData
 */
export interface BulkSendValidateCsv422ResponseErrorsBulkSendCsvInnerData {
    /**
     * 
     * @type {string}
     * @memberof BulkSendValidateCsv422ResponseErrorsBulkSendCsvInnerData
     */
