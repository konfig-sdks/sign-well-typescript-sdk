 ...
 * 
 * @export
 * @interface TemplateCreateNew422ResponseErrorsFilesFile3
 */
export interface TemplateCreateNew422ResponseErrorsFilesFile3 {
    /**
     * 
     * @type {Array<string>}
     * @memberof TemplateCreateNew422ResponseErrorsFilesFile3
     */
