 ...
 * 
 * @export
 * @interface TemplateUpdateExistingTemplateResponseFilesInner
 */
export interface TemplateUpdateExistingTemplateResponseFilesInner {
    /**
     * 
     * @type {string}
     * @memberof TemplateUpdateExistingTemplateResponseFilesInner
     */
    'name'?: string;
    /**
     * 
