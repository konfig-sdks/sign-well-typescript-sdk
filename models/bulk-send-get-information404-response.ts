...
import { BulkSendGetInformation404ResponseMeta } from './bulk-send-get-information404-response-meta';

/**
 * 
 * @export
 * @interface BulkSendGetInformation404Response
 */
export interface BulkSendGetInformation404Response {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetInformation404Response
     */
    'message'?: string;
    /**
     * 
     * @type {BulkSendGetInformation404ResponseMeta}
     * @memberof BulkSendGetInformation404Response
     */
    'meta'?: BulkSendGetInformation404ResponseMeta;
}
