...
import { DocumentResponseRecipientsInnerAttachmentRequestsInner } from './document-response-recipients-inner-attachment-requests-inner';

/**
 * 
 * @export
 * @interface DocumentFromTemplateResponseRecipientsInner
 */
export interface DocumentFromTemplateResponseRecipientsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentFromTemplateResponseRecipientsInner
     */
    'name'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<DocumentResponseRecipientsInnerAttachmentRequestsInner>}
     * @memberof DocumentFromTemplateResponseRecipientsInner
     */
    'attachment_requests'?: Array<DocumentResponseRecipientsInnerAttachmentRequestsInner>;
    /**
     * 
     * @type {string}
     * @memberof DocumentFromTemplateResponseRecipientsInner
