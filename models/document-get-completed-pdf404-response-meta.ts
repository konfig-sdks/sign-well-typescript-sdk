 ...
 * 
 * @export
 * @interface DocumentGetCompletedPdf404ResponseMeta
 */
export interface DocumentGetCompletedPdf404ResponseMeta {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetCompletedPdf404ResponseMeta
     */
    'error'?: string;
    /**
     * 
