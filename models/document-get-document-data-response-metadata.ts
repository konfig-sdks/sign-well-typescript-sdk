 ...
 * 
 * @export
 * @interface DocumentGetDocumentDataResponseMetadata
 */
export interface DocumentGetDocumentDataResponseMetadata {
    /**
     * 
     * @type {string}
     * @memberof DocumentGetDocumentDataResponseMetadata
     */
    'amet'?: string;
    /**
     * 
