 ...
 * 
 * @export
 * @interface TemplateUpdateExistingTemplateResponseMetadata
 */
export interface TemplateUpdateExistingTemplateResponseMetadata {
    /**
     * 
     * @type {string}
     * @memberof TemplateUpdateExistingTemplateResponseMetadata
     */
    'some'?: string;
}
