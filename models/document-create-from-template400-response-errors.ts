 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate400ResponseErrors
 */
export interface DocumentCreateFromTemplate400ResponseErrors {
    /**
     * 
     * @type {string}
     * @memberof DocumentCreateFromTemplate400ResponseErrors
     */
    'message'?: string;
    /**
     * 
