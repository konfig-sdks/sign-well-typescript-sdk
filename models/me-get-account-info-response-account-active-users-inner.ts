 ...
 * 
 * @export
 * @interface MeGetAccountInfoResponseAccountActiveUsersInner
 */
export interface MeGetAccountInfoResponseAccountActiveUsersInner {
    /**
     * 
     * @type {string}
     * @memberof MeGetAccountInfoResponseAccountActiveUsersInner
     */
    'id'?: string;
    /**
     * 
