...
import { DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInner } from './document-send-reminder-response-recipients-inner-attachment-requests-inner';

/**
 * 
 * @export
 * @interface DocumentSendReminderResponseRecipientsInner
 */
export interface DocumentSendReminderResponseRecipientsInner {
    /**
     * 
     * @type {string}
     * @memberof DocumentSendReminderResponseRecipientsInner
     */
    'email'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInner>}
     * @memberof DocumentSendReminderResponseRecipientsInner
     */
    'attachment_requests'?: Array<DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInner>;
}
