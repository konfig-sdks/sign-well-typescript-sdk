...
import { DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInnerOneOf } from './document-send-reminder-response-recipients-inner-attachment-requests-inner-one-of';

/**
 * @type DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInner
 * @export
 */
export type DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInner = DocumentSendReminderResponseRecipientsInnerAttachmentRequestsInnerOneOf | string;
