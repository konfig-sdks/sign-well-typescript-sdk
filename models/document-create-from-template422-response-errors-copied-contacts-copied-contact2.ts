 ...
 * 
 * @export
 * @interface DocumentCreateFromTemplate422ResponseErrorsCopiedContactsCopiedContact2
 */
export interface DocumentCreateFromTemplate422ResponseErrorsCopiedContactsCopiedContact2 {
    /**
     * 
     * @type {Array<string>}
     * @memberof DocumentCreateFromTemplate422ResponseErrorsCopiedContactsCopiedContact2
     */
    'email'?: Array<string>;
}
