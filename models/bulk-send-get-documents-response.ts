...
import { BulkSendGetDocumentsResponseDocumentsInner } from './bulk-send-get-documents-response-documents-inner';

/**
 * 
 * @export
 * @interface BulkSendGetDocumentsResponse
 */
export interface BulkSendGetDocumentsResponse {
    /**
     * 
     * @type {string}
     * @memberof BulkSendGetDocumentsResponse
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<BulkSendGetDocumentsResponseDocumentsInner>}
     * @memberof BulkSendGetDocumentsResponse
     */
    'documents'?: Array<BulkSendGetDocumentsResponseDocumentsInner>;
    /**
     * 
     * @type {number}
     * @memberof BulkSendGetDocumentsResponse
